...
*	函 数 名: F2CA
*	功能说明: 转换float数据到字节数组
*	形    参：float floatVariable:待转换float, unsigned char charArray[4] 存储字节数组
*	返 回 值: 无
*********************************************************************************************************
*/
...
unsigned char i;  
unsigned char * pdata;
  pdata = (unsigned char*)&floatVariable;  //?float??????????unsigned char?  
for(i=0;i<4;i++)  
{ 
    charArray[i] = *pdata++;//????????????unsigned char???  
}  
...
*	函 数 名: CA2F
*	功能说明: 转换字节数组到float
*	形    参：float floatVariable:存储float, unsigned char charArray[4] 待转换字节数组
*	返 回 值: 无
*********************************************************************************************************
*/
